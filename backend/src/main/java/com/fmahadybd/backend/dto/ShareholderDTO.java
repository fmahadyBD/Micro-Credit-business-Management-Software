...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Shareholder Data Transfer Object")
public class ShareholderDTO {
    ...
    @Schema(description = "Return on Investment percentage")
    private Double roi;
    
    @Schema(description = "Total value (investment + earnings)")
