...
public interface ShareholderRepository extends JpaRepository<Shareholder, Long> {
    ...
    List<Shareholder> findByJoinDateBetween(@Param("startDate") LocalDate startDate, @Param("endDate") LocalDate endDate);
    ...
    List<Shareholder> findByStatusAndMinInvestment(@Param("status") String status, @Param("minInvestment") Double minInvestment);
