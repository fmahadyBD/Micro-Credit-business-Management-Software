...
//     @Operation(summary = "Add withdrawal", description = "Processes withdrawal from main balance")
//     @ApiResponses({
...
//     })
//     public ResponseEntity<String> addWithdrawal(@Valid @RequestBody WithdrawalRequestDTO request) {
...
//     }
    ...
    @ApiResponse(responseCode = "200", description = "Transactions retrieved successfully", content = @Content(schema = @Schema(implementation = TransactionHistoryResponseDTO.class)))
    public ResponseEntity<List<TransactionHistoryResponseDTO>> getTransactionsByMember(@PathVariable Long memberId) {
        List<TransactionHistory> transactions = transactionHistoryRepository
