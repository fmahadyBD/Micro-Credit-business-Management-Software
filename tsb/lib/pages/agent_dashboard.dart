...
class _AgentDashboardState extends State<AgentDashboard>
  ...
  String _getPageTitle() {
    final titles = {
      'dashboard': 'এজেন্ট ড্যাশবোর্ড',
      'all_products': 'সমস্ত পণ্য',
      'add_product': 'নতুন পণ্য',
      'all_members': 'সমস্ত সদস্য',
      'new_member': 'নতুন সদস্য',
      'manage_installment': 'কিস্তি ব্যবস্থাপনা',
      'add_installment': 'নতুন কিস্তি',
      'record_payment': 'পেমেন্ট রেকর্ড',
      'profile': 'আমার প্রোফাইল',
    };
    return titles[currentPage] ?? 'এজেন্ট ড্যাশবোর্ড';
  }
  ...
  Widget _buildAgentDashboardHome() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Main Balance Card (now at the top)
          _buildBalanceCard(),
          ...
          _buildQuickActionCard(
            ...
            subtitle: 'সিস্টেমে নতুন সদস্য নিবন্ধন করুন',
            color: Colors.teal,
            onTap: () {
              setState(() {
          ...
          _buildQuickActionCard(
            ...
            subtitle: 'একটি নতুন পেমেন্ট লেনদেন রেকর্ড করুন',
            color: Colors.indigo,
            onTap: () {
              setState(() {
          ...
          _buildQuickActionCard(
            ...
            subtitle: 'একটি নতুন কিস্তি পরিকল্পনা তৈরি করুন',
