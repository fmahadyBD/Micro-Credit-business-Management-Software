    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('ব্যবহারকারী লোড করতে সমস্যা: $e'),
  ...
  Future<void> _confirmDelete(UserModel user) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'আপনি কি নিশ্চিত যে "${user.firstname} ${user.lastname}" কে মুছতে চান?\n\nএই কাজটি পূর্বাবস্থায় ফিরিয়ে আনা যাবে না।',
    ...
    if (confirmed == true) {
      try {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('ব্যবহারকারী সফলভাবে মুছে ফেলা হয়েছে'),
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('ব্যবহারকারী মুছতে সমস্যা: $e'),
              backgroundColor: Colors.red,
            ),
          );
        }
                        ...
                        children: [
                          ...
                          if (_searchQuery.isNotEmpty)
                            Padding(
                              ...
                              child: Text(
                                '"$_searchQuery" এর জন্য কোন ফলাফল নেই',
                                style: TextStyle(
                                  fontSize: 14,
