...
class InstallmentAddScreen extends StatefulWidget {
  const InstallmentAddScreen({super.key});
...
class _InstallmentAddScreenState extends State<InstallmentAddScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadAgents() async {
    try {
      ...
      _showErrorSnackBar('এজেন্ট লোড করতে সমস্যা: $e');
    }
  }
  ...
  Future<void> _searchProducts(String query) async {
    ...
    try {
      ...
      _showErrorSnackBar('পণ্য খুঁজতে সমস্যা: $e');
    }
  }
  ...
  Future<void> _searchMembers(String query) async {
    ...
    try {
      ...
      _showErrorSnackBar('সদস্য খুঁজতে সমস্যা: $e');
    }
  }
  ...
  void _selectProduct(ProductModel product) async {
    ...
    if (product.soldByAgentId != null) {
      try {
        ...
        _showSuccessSnackBar('পণ্য থেকে এজেন্ট স্বয়ংক্রিয়ভাবে নির্বাচিত হয়েছে');
      } catch (e) {
    ...
    if (product.whoRequestId != null) {
      try {
        ...
        _showSuccessSnackBar('পণ্য থেকে সদস্য স্বয়ংক্রিয়ভাবে নির্বাচিত হয়েছে');
      } catch (e) {
        print('Error auto-selecting member: $e');
        _showErrorSnackBar('এই পণ্যের জন্য সদস্য পাওয়া যায়নি');
      }
    }
  ...
  Future<void> _saveInstallment() async {
    ...
    if (_selectedProduct == null) {
      _showErrorSnackBar('দয়া করে একটি পণ্য নির্বাচন করুন');
      return;
    }
    
    if (_selectedMember == null) {
      _showErrorSnackBar('দয়া করে একজন সদস্য নির্বাচন করুন');
      return;
    }
    
    if (_selectedAgent == null) {
      _showErrorSnackBar('দয়া করে একজন এজেন্ট নির্বাচন করুন');
      return;
    }
    ...
    try {
      // Convert Bangla status to English for backend
      String statusEnglish = 'ACTIVE';
      ...
      _showSuccessSnackBar('কিস্তি সফলভাবে তৈরি করা হয়েছে');
          ...
          const SnackBar(
            content: Row(
              children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text('কিস্তি তৈরি হয়েছে! সদস্য ও এজেন্টের তথ্য সংরক্ষিত আছে।')),
              ],
            ),
  ...
  Widget _buildProductSearchDropdown() {
    return Column(
      ...
      children: [
        Text('পণ্য খুঁজুন *', style: TextStyle(
  ...
  Widget _buildMemberSearchDropdown() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('সদস্য খুঁজুন *', style: TextStyle(
          fontWeight: FontWeight.bold,
          fontSize: 16,
          color: Colors.grey[800],
        )),
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            hintText: 'সদস্যের নাম বা ফোন নম্বর লিখুন...',
            prefixIcon: Icon(Icons.search, color: Colors.blue[700]),
            ...
            children: [
              ...
              _buildAnimatedFormField(
                _buildStyledTextFormField(
                  ...
                  validator: (value) => value?.isEmpty ?? true ? 'প্রয়োজনীয়' : null,
                ),
              ),
              const SizedBox(height: 16),
              ...
              _buildAnimatedFormField(
                _buildStyledDropdown<AgentModel>(
                  ...
                  validator: (value) => value == null ? 'প্রয়োজনীয়' : null,
                ),
              ),
              const SizedBox(height: 16),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              const Text(
                                'পরবর্তী কিস্তির জন্য ডাটা রাখুন',
                                style: TextStyle(
                                  fontWeight: FontWeight.w600,
                                  fontSize: 14,
                                ),
                              ...
                              Text(
                                'সদস্য এবং এজেন্ট ডাটা সংরক্ষণ করুন',
                                style: TextStyle(
                                  color: Colors.grey[600],
                                  fontSize: 12,
                                ),
                        ...
                        child: _isLoading
                            ...
                            : const Row(
                                ...
                                children: [
                                  Icon(Icons.save),
                                  SizedBox(width: 8),
                                  Text('কিস্তি তৈরি করুন', style: TextStyle(fontSize: 16)),
                                ],
                              ),
                      ),
                    ),
                      ...
                      child: OutlinedButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text('রিসেট', style: TextStyle(color: Colors.grey[600])),
                          ],
                        ),
                      ),
                    ),
