...
class InstallmentModel {
  ...
  factory InstallmentModel.fromJson(Map<String, dynamic> json) {
    ...
    // Safe parsing for member
    MemberModel? parsedMember;
    if (json['member'] != null) {
      try {
        parsedMember = MemberModel.fromJson(json['member']);
      } catch (e) {
  ...
  @override
  String toString() {
    return 'InstallmentModel(id: $id, productId: $productId, memberId: $memberId, totalAmount: $totalAmountOfProduct, status: $status, createdTime: $createdTime, images: ${imageFilePaths.length})';
  }
}
