...
class PaymentHistoryScreen extends StatefulWidget {
  ...
  const PaymentHistoryScreen({Key? key, this.installmentId}) : super(key: key);
          ...
          pw.Container(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                _buildPdfRow('Name', _installment!.member!.name!),
                _buildPdfRow('Phone', _installment!.member!.phone!),
                _buildPdfRow('Product', _installment!.product!.name),
  ...
  Widget _buildContent() {
    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          // Summary Card
          if (_balance != null) _buildSummaryCard(),
