...
import { ShareholderCreateDto } from '../../models/shareholder-create-dto';

export interface CreateShareholder$Params {
      body: ShareholderCreateDto
}
...
createShareholder.PATH = '/api/shareholders';
