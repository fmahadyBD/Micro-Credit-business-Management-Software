...
export function deleteProductImage(http: HttpClient, rootUrl: string, params: DeleteProductImage$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
